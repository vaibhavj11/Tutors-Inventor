...
@media only screen and (min-width: 768px) and (max-width: 1350px) {
  .my-table {
    margin: 15px; /* reduce margin to adjust for smaller screens */
    ...
    <tbody>
      <tr>
       <td>${e.fname}</td>
          ...
          <td>${e.bio}</td>
          <td>
          <a href="edittutor?id=${e.id}"><i class='fa fa-edit' style="color:gold"></i></a> |
          <a href="deletetutor?id=${e.id}"><i class="fa fa-trash" style="color:gold"></i></a>
          </td>
