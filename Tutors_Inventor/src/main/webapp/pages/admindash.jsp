  ...
  <div class="container">
    ...
    <div class="main">
      ...
      <div class="dashboard">
        ...
        <div class="numbers">
          <div class="count-tutors">
            <h2>Total Tutors: ${totaltutor} </h2>
          </div>
          <div class="count-parents">
            <h2>Total Parents: ${totalparent}</h2>
          </div>
          <div class="count-ebooks">
            <h2>Total Ebooks: ${totalebook} </h2>
          </div>
        </div>
      </div>
